...
class GameCubeFEController extends HtmlGuiInterface {
    var $theContainer;

    public function GameCubeFEController() {
  ...
  <tr>
    <td colspan='3'><object id='FlashID' classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' width='715' height='343'>
      <param name='movie' value='banner_gamecube.swf' />
      ...
      <!--[if !IE]>-->
      <object type='application/x-shockwave-flash' data='banner_gamecube.swf' width='715' height='343'>
        <!--<![endif]-->
        <param name='quality' value='high' />
        <param name='wmode' value='opaque' />
        <param name='swfversion' value='6.0.65.0' />
  ...
  <tr>
    <td colspan='3'><img src='combo1gc.jpg' width='715' height='220' alt='combo 1 gamecube' /></td>
  </tr>
  <tr>
