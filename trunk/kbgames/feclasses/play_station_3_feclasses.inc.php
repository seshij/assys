...
class PlayStation3FEController extends HtmlGuiInterface {
    var $theContainer;

    public function PlayStation3FEController() {
        $this->theContainer=new HtmlContainer();

    }

    public function getHtml() {
        $this->getPlayStation3();
    ...
    public function getPlayStation3() {
  ...
  <tr>
    <td colspan='3'><object id='FlashID' classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' width='715' height='343'>
      <param name='movie' value='banner_ps3.swf' />
      ...
      <!--[if !IE]>-->
      <object type='application/x-shockwave-flash' data='banner_ps3.swf' width='715' height='343'>
        <!--<![endif]-->
        <param name='quality' value='high' />
        <param name='wmode' value='opaque' />
        <param name='swfversion' value='6.0.65.0' />
  ...
  <tr>
    <td colspan='3'><img src='combo_consola.jpg' width='715' height='220' alt='combo 1 Ps3' /></td>
  </tr>
  <tr>
    <td colspan='3'><img src='combo1.jpg' width='715' height='220' /></td>
  </tr>
  <tr>
